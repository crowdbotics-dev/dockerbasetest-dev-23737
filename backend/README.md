...
## Project Structure
    ...
    ├── dockerbasetest_dev_23737  # Django project configurations
...
1. Clone this repo and `cd dockerbasetest_dev_23737`
...
2. Clone this repo and `cd dockerbasetest_dev_23737`
